#!/usr/bin/env python3
"""
Build bloodAGENT-format variation_annotation.dat from ISBT V16 API dumps.
...
Output (in --out-dir, default derived/):
  - variation_annotation.v16.dat: tab-separated, schema = bloodAGENT master schema (28 cols)
...
HIGH_IMPACT_MARKERS = {
    ...
    ("ABO", "261del"),  # V16 short HGVS drops the deleted base (was 261delG)
    ("JK", "499A>G"),
    ("P1PK", "109A>G"),
...
def load_strand_map(old_master_path: Path | None) -> dict:
    """Build {gene_name -> '+'/'-'} from:
       ...
       3. EXTRA_STRAND hardcoded for V16 new systems (12 systems not in old master)
    """
    SYM_TO_GENE = {
...
def main():
    ...
    out_dat = out / "variation_annotation.v16.dat"
