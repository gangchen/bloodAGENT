#!/usr/bin/env bash
# Fetch full ISBT Blood Group Database V16 snapshot via the public REST API.
#
# Usage: ./fetch_isbt_v16.sh [RAW_DIR]
...
#   2. Dumps /api/release/16 for the V16 release object incl. updatedAlleleIds
...
echo "[2/3] fetching release/16 ..."
curl -sL --retry 3 "${API}/release/16" -o "${RAW_DIR}/release_16.json"
