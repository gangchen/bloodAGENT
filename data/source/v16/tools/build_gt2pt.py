#!/usr/bin/env python3
"""
Build bloodAGENT-format genotype_to_phenotype_annotation*.dat from ISBT V16 API dumps.
...
Schema (10 cols, TAB):
  ...
  5 Phenotype_PDF_Table -- isbt_phenotype (verbatim from V16)
...
Output (in --out-dir):
  - genotype_to_phenotype_annotation.v16.dat
"""
...
def main():
    ...
    out_path = out / "genotype_to_phenotype_annotation.v16.dat"
